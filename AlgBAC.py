...
with open("./tests.yaml", 'r') as file:
    ...
    def simulation(n, dropProbability, f, strategy):
        ...
        while(not(complete)):
            ...
            if(strategy == 1):
                simulation_byzantine1(nodes, crashedNodes, dropProbability, probabilityMatrix, round, rounds, p_end, n, f)
            else:
                simulation_byzantine2(nodes, crashedNodes, dropProbability, probabilityMatrix, round, rounds, p_end, n, f)
    ...
    def makeBoxplot_algAC(resultsDict):
        ...
        filename = "algBAC-test" + str(numNodes) + "-" + str(numFaultyNodes) + "-" + str(crashProbability) + "-" + str(strategy) + ".pdf"
